...
export const Facebook = (props) => (
  ...
  >
    <path
      d="M154.571 0C69.662 0 .83 68.831.83 153.741c0 38.283 13.997 73.295 37.147 100.207-6.953 19.986-19.807 37.209-36.479 49.581a104.195 104.195 0 0 0 33.757 5.613c20.214 0 39.082-5.751 55.067-15.698 19.551 9.007 41.312 14.039 64.249 14.039 84.909 0 153.741-68.833 153.741-153.742C308.313 68.831 239.48 0 154.571 0z"
      style={{
        fill: "#005cb9",
      }}
    />
    <path
      d="M131.495 240.044h36.112v-90.282h26.804l3.29-36.115h-28.7v-14.44c0-7.037 4.69-8.671 7.984-8.671h20.258V59.593l-27.895-.113c-30.963 0-38.002 23.075-38.002 37.849v16.318H113.44v36.115h18.056l-.001 90.282z"
      style={{
        fill: "#fff",
      }}
    />
